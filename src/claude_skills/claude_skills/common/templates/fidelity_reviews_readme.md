...
When you run fidelity review commands without `--output`, both Markdown and JSON artifacts are automatically saved here:

```bash
# Task-level fidelity review
sdd fidelity-review <spec-id> --task <task-id>
# Output: specs/.fidelity-reviews/<spec-id>-task-<task-id>-fidelity-review.{md,json}

# Phase-level fidelity review
sdd fidelity-review <spec-id> --phase <phase-id>
# Output: specs/.fidelity-reviews/<spec-id>-phase-<phase-id>-fidelity-review.{md,json}
```
