...
When you run fidelity review commands, outputs are automatically saved here:

```bash
# Task-level fidelity review
sdd fidelity-review <spec-id> --task <task-id>
# Output: specs/.fidelity-reviews/<spec-id>-task-<task-id>-fidelity-review.md

# Phase-level fidelity review
sdd fidelity-review <spec-id> --phase <phase-id>
# Output: specs/.fidelity-reviews/<spec-id>-phase-<phase-id>-fidelity-review.md
```
...
find specs/.fidelity-reviews -name "*.md" -mtime +30 -delete
```
...
├── README.md                                           # This file
├── <spec-id>-task-<task-id>-fidelity-review.md       # Task-level review
├── <spec-id>-phase-<phase-id>-fidelity-review.md     # Phase-level review
└── <spec-id>-fidelity-review-<timestamp>.md          # Historical versions
```
