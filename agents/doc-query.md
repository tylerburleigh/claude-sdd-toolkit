...
This agent invokes the `doc-query` skill to perform targeted queries on machine-readable codebase documentation generated by the `code-doc` skill.
...
- Generating documentation (use code-doc instead)
...
**IMPORTANT**: This skill requires documentation generated by `Skill(sdd-toolkit:code-doc)`.

If documentation doesn't exist:
1. First invoke: `Skill(sdd-toolkit:code-doc)`
...
- Suggested resolution:
  - If docs missing: "Run Skill(sdd-toolkit:code-doc) first"
  - If entity not found: "Verify entity name or try pattern matching"
  - If docs stale: "Allow auto-regeneration or run code-doc manually"
