"""
Tests for add_node() function in sdd_spec_mod module.
"""

import pytest
from claude_skills.sdd_spec_mod.modification import add_node, _propagate_task_count_increase
...
class TestAddNode:
    ...
    def test_add_task_updates_parent_counts(self):
    ...
    def test_add_node_duplicate_id_fails(self):
    ...
    def test_add_node_invalid_parent_raises_error(self):
    ...
    def test_add_node_missing_required_fields_raises_error(self):
    ...
    def test_add_node_empty_title_fails(self):
    ...
    def test_propagate_task_count_increase(self):
