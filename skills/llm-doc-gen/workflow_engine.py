...
This module implements the BMAD-style workflow execution system, enabling:
...
Based on BMAD workflow patterns from:
- /Users/tylerburleigh/Downloads/BMAD-METHOD-main/src/core/tasks/workflow.xml
- /Users/tylerburleigh/Downloads/BMAD-METHOD-main/src/core/tasks/advanced-elicitation.xml
"""
...
class WorkflowEngine:
    ...
    def resolve_variables(self):
        ...
        Implements BMAD variable resolution order:
...
class DocumentationWorkflow:
    ...
    def _discover_inputs_protocol(self):
        ...
        Implements BMAD discover_inputs protocol with smart loading strategies:
